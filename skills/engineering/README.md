...
- **[ccr](./ccr/SKILL.md)** — Run local Claude code review for current changes.
...
- **[to-issues2](./to-issues2/SKILL.md)** — Review-friendly Chinese variant of `to-issues` with diff budgets and PR review guides.
...
- **[project-strategist](./project-strategist/SKILL.md)** — Analyze planning state and generate a Chinese project strategy report.
